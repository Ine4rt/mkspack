...
header("Content-Disposition: attachment; filename=commandes_sprimont.xls");
...
echo "Pack\tDate\tNom\tPrénom\tCatégorie\tTéléphone\tEmail\tRôle\tVeste\tPantalon\tBas\tShort\tMaillot\tPolo\tInitiales\tCoti Payée\tFacturé\tTerminé\n";
...
while ($row = $result->fetch_assoc()) {
	...
	echo htmlspecialchars($row['short_size']) . "\t";
		...
		echo htmlspecialchars($row['polo_size']) . "\t";
