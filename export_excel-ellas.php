...
header("Content-Disposition: attachment; filename=commandes_ellas.xls");
...
echo "Pack\tDate\tNom\tPrénom\tCatégorie\tTéléphone\tEmail\tRôle\tVeste\tPantalon\tKit\tShort\tBas\tPolo\tInitiales\tCoti Payée\tFacturé\tTerminé\n";
