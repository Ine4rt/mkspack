...
<head>
    <meta charset="UTF-8">
    <title>Bon de commande - Ellas</title>
    <style>
    ...
    <script>
        ...
        fetch('get_order_details.php?orderId=' + orderId)
            ...
            .then(order => {
                ...
                let titrePack = 'Pack Ellas';
                if(data.role==='Ellas-Keeper') titrePack='Pack Ellas Keeper';
                if(data.role==='Ellas-Entraineur') titrePack='Pack Ellas Entraineur';
                ...
                if(data.role==='Ellas-Keeper'){
                    ...
                    references={veste:"100527511", pantalon:"100530403", kit:"100531701"};
                } else if(data.role==='Ellas-Entraineur'){
                    titles={veste:"Veste Entraineur", pantalon:"Pantalon", polo:"Polo", short:"Short"};
                    references={veste:"100226901", pantalon:"100530403", polo:"100227601", short:"100529001"};
                } else {
                    titles={veste:"Veste", pantalon:"Pantalon", kit:"Kit", bas:"Bas"};
                    references={veste:"100527511", pantalon:"100530403", kit:"100345111", bas:"100369701"};
                }
                ...
                if(data.initials && data.initials.trim()!==''){
                    initialesHTML=`<div class="grid-container" style="grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); max-width: 400px; margin: 0 auto;"><div class="item-box"><div class="item-title">Numero</div><div class="item-size">${data.initials}</div></div></div>`;
                } else {
