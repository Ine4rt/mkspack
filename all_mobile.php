...
$sql = "SELECT * FROM orders WHERE club = '" . $conn->real_escape_string($club) . "'";
			...
			$scanClass = ($row['scan'] == 1) ? 'scan-yellow' : '';
                ...
                $greyClass = (strtolower(trim($row['email'])) === '<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="cfbcbbaabfa7aea1a6aa8fa2a4bcb8aaade1adaa">[email&#160;protected]</a>') ? 'grey-row' : '';
