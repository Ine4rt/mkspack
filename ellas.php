...
let initPrix = (init && init.trim() !== '') ? '20€' : '';
...
let titrePack = 'Pack Ellas'; // par défaut

if (role.trim() === 'Ellas-Keeper') {
    titrePack = 'Pack Ellas Keeper';
} else if (role.trim() === 'Ellas-Entraineur') {
    titrePack = 'Pack Ellas Entraineur';
}
...
<div class="grid-container" style="grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); max-width: 400px; margin: 0 auto;">
    <div class="item-box">
        <div class="item-title">Numero</div>
...
<div id="filterContainer">
	...
	<button class="filter-btn" onclick="filterByRole('Ellas-Entraineur', this)">Entraineur</button>
    ...
    <table>
        <thead>
            <tr>
				...
				<th>Short </br> 100529001</th>
				<th>Polo </br> 100227601</th>
                <th>Numero</th>
...
echo "<td>" . $date->format('d/m') . "</td>";
                ...
                } elseif ($row['role'] == 'Ellas-Entraineur') {
                    echo "👶🏻"; // Icône paire de gants
                }
                echo "</td>";
...
function exportToExcel() {
    window.location.href = 'export_excel-ellas.php';
}
...
function toggleFilter() {
    ...
    } else if (currentFilter === "Ellas-Entraineur") {
        currentFilter = "Ellas-Entraineur";
    ...
    rows.forEach(row => {
        ...
        if (roleCell) {
            ...
            if (currentFilter === "all" || role === "👶🏻" && currentFilter === "Ellas-Entraineur" || role === "⚽️" && currentFilter === "Ellas-Joueur" || role === "🧤" && currentFilter === "Ellas-Keeper") {
                row.style.display = "";
            } else {
...
function filterByRole(role, button) {
    ...
    rows.forEach(row => {
        ...
        if (roleCell) {
            ...
            if (
    role === "all" ||
    (role === "Ellas-Joueur" && roleText === "⚽️") ||
    (role === "Ellas-Keeper" && roleText === "🧤") ||
