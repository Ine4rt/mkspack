...
let titrePack = (role.toLowerCase() === 'keeper') ? 'Pack Bas-Oha Keeper' : 'Pack MKSGK';
    ...
    height: 80px;
                        ...
                        <body>
                            <div class="container">
                                ...
                                <img src="MKSGK.png" class="logo" alt="Logo Club">
                                <h2>${titrePack}</h2>
...
<div class="grid-container" style="grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); max-width: 400px; margin: 0 auto;">
    <div class="item-box">
        <div class="item-title">Parrain</div>
...
<div style="display: flex; justify-content: center; margin-top: 15px;">
    <div class="item-box" style="min-width: 160px;">
        <div class="item-title" style="font-size: 16px; padding: 10px;">Parrain</div>
...
<body>
    ...
    <div class="club-container">
        <img src="MKSGK.png" alt="MKSGK" class="club-logo">
        <span style="font-size: 40px; font-weight: bold;">MKSGK</span>
...
<label><input type="checkbox" class="filter" id="filter_non_termine" onchange="onFilterChange()"> Non terminé</label>
    ...
    <table>
        ...
        <tbody>
            ...
            $sql = "SELECT * FROM orders WHERE club = 'MKSGK'";
...
function exportToExcel() {
    window.location.href = 'export_excel-MKSGK.php';
}
