...
<div style="text-align: center; font-family: Arial, sans-serif; margin-top: 20px;">
    <h2 style="color: red; font-size: 24px; margin-bottom: 10px;">
        Votre pack a bien été enregistré test.
    </h2>
...
<div style="text-align: center; font-family: Arial, sans-serif; margin-top: 20px;">
    ...
    <p style="font-size: 16px; color: #333; margin-top: 10px;">
        Grâce à celle-ci, tu bénéficies du <strong>Starter Pack</strong> !
    </p>
    <p style="font-size: 16px; color: #333; margin-top: 20px;">
        Tu recevras un <strong>mail</strong> une fois ton pack vêtements terminé !
    </p>
    <p style="font-size: 16px; color: #333; margin-top: 20px;">
        Chez <strong>Marksports Arena</strong>, situé <strong>Rue Chaussée 90, 4342 Hognoul</strong>, 
        il ne reste qu’à choisir en magasin les gants de ton Starter Pack !
    </p>
    <h3 style="font-size: 18px; margin-top: 30px;">Passe récupérer dès le mail pack terminé reçu :</h3>
    <ul style="list-style: none; padding: 0; font-size: 16px; color: #333; text-align: left; max-width: 500px; margin: 20px auto;">
        <li>🎁 Une carte cadeau <strong>-20%</strong></li>
        <li>🎁 Un t-shirt <strong>Uhlsport</strong></li>
        <li>🎁 Un sweat <strong>Uhlsport</strong></li>
        <li>🎁 Un sac à gants <strong>Uhlsport</strong></li>
    </ul>
    <p style="font-size: 16px; margin-top: 20px;">
        À très vite,<br>
        <strong>L’équipe Marksports Arena</strong>
    </p>
</div>';
