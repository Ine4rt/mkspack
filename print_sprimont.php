...
<head>
    <meta charset="UTF-8">
    <title>Bon de commande - Sprimont</title>
    <style>
...
<body>
    <div class="container">
        ...
        <h2 id="titrePack">Pack RFCB Sprimont</h2>
        ...
        <div class="line"></div>
        <div id="initialesPrixContainer"></div>
    ...
    <script>
        ...
        fetch('get_order_details.php?orderId=' + orderId)
            ...
            .then(order => {
                ...
                let titrePack = 'Pack RFCB Sprimont';
                if(data.role==='Ellas-Keeper') titrePack='Pack Ellas Keeper';
                if(data.role==='Entraineur') titrePack='Pack Sprimont Entraîneur';
                ...
                if(data.role==='Ellas-Keeper'){
                    ...
                    titles={veste:"Veste Entraineur", pantalon:"Pantalon Entraineur", short:"Short Entraineur", jersey:"Maillot Entraineur"};
                    references={veste:"100226901", pantalon:"100522101", short:"100530601", jersey:"100226601"};
                } else {
                ...
                if(data.initials && data.initials.trim()!==''){
                    ...
                    <div class="grid-container" style="grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); max-width: 400px; margin: 0 auto;">
                        <div class="item-box"><div class="item-title">Initiales</div><div class="item-size">${data.initials}</div></div>
                    ...
                    initialesPrixHTML=`<div style="display: flex; justify-content: center; margin-top: 15px;"><div class="item-box" style="min-width: 160px;"><div class="item-title" style="font-size: 16px; padding: 10px;">Initiales</div><div class="item-size" style="font-size: 16px;">NON</div></div></div>`;
                }
                document.getElementById('initialesPrixContainer').innerHTML = initialesPrixHTML;
