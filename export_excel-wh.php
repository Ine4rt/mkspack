...
header("Content-Disposition: attachment; filename=commandes_wh.xls");
...
echo "Pack\tDate\tNom\tPrénom\tCatégorie\tTéléphone\tEmail\tRôle\tVeste\tPantalon\tBas\tMaillot\tInitiales\tCoti Payée\tFacturé\tTerminé\n";
