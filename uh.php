...
let titrePack = (role.toLowerCase() === 'keeper') ? 'Pack Bas-Oha Keeper' : 'Pack Union Hutoise';
...
#qrcode {
    ...
    <div class="item-size">${veste}</div>
                                    ...
                                    <div class="item-box">
                                        <div class="item-title">${titles.jersey}
										<div class="item-reference">${references.jersey}</div> <!-- Nouveau bloc pour la référence --></div>
										
                                        <div class="item-size">${jersey}</div>
                                    </div>
									<div class="item-box">
                                        <div class="item-title">${titles.short}
										<div class="item-reference">${references.short}</div> <!-- Nouveau bloc pour la référence --></div>
										
                                        <div class="item-size">${short}</div>
                                    </div>
                                    <div class="item-box">
...
<div class="grid-container" style="grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); max-width: 400px; margin: 0 auto;">
    ...
    <div class="item-box" style="border: 2px solid #c00; background-color: #ffe6e6;">
        ...
        <div class="item-size" style="color: #900; font-weight: bold;">10€</div>
    </div>
</div>
` : `
...
<body>
    ...
    <div class="club-container">
        <img src="uh.png" alt="Union Hutoise" class="club-logo">
        <span style="font-size: 40px; font-weight: bold;">Union Hutoise</span>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Veste </br> 100527505</th>
                <th>Pantalon </br> 100522101</th>
                <th>Maillot </br> 100225331</th>
                <th>Short </br> 100530601</th>
                <th>Bas </br> 100369709</th>
                <th>Initiales</th>
        ...
        <tbody>
            ...
            $sql = "SELECT * FROM orders WHERE club = 'Union Hutoise'";
...
function exportToExcel() {
    window.location.href = 'export_excel-uh.php';
}
...
function applyFilters() {
    ...
    rows.forEach(row => {
        ...
        const cotiInput = row.querySelector("td:nth-child(15) input");
        const coti = cotiInput && cotiInput.value.trim() !== "";

        const factureInput = row.querySelector("td:nth-child(16) input");
        const facture = factureInput && factureInput.value.trim() !== "";

        const reprisInput = row.querySelector("td:nth-child(17) input");
